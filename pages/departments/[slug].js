    ...
    <Layout title={department.slug}>
      <div>
        ...
        <div className="">
          ...
          <div className="grid  grid-cols-1  lg:grid-cols-4 px-12 md:grid-cols-2 mb-5 rounded-lg border border-gray-100 shadow md:pl-[9rem] pr-20 gap-5 bg-[#023047]">
            {department.executives.map((executive, _index) => (
              <div className="">
                <div className="pl-[3rem]">
                  ...
                  <div className="text-1xl capitalize text-[#ffb703] font-semibold pb-5">
